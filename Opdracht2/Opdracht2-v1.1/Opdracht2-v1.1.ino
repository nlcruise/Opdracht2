 ...
 * Wouter Honselaar (17053994) en Peter Ng (17065186)
 * Deze versie is gemaakt door Wouter Honselaar
 * Peter Ng heeft zijn eigen versie geupload op Blackboard
 * Klas 2A, Delft
 * Functies:
 ...
 * - Code uit PowerPoint-presentatie hoorcollege Embedded Systems week 3
